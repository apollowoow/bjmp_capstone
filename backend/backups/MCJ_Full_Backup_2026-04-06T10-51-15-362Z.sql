...
\restrict d3R79pgZB6Cmyv0d96fSK7wVDbJJihMNqIJPlvdQW8b3JxGtubxEuGeISln61e4
...
CREATE TABLE public.pdl_subsidiary_tbl (
    ...
    CONSTRAINT pdl_subsidiary_tbl_status_check CHECK (((status)::text = ANY ((ARRAY['Active'::character varying, 'Paid'::character varying, 'Served'::character varying, 'Cancelled'::character varying])::text[])))
);
...
569	11	SYSTEM_MAINTENANCE_ACCESS_GRANTED	audit_log_tbl	11	{"message": "SYSTEM_MAINTENANCE module successfully unlocked.", "authorized_user": "Admin Aguigam"}	192.168.254.128	2026-04-06 18:44:26.563574	\N
570	11	SYSTEM_MAINTENANCE_ACCESS_GRANTED	audit_log_tbl	11	{"message": "SYSTEM_MAINTENANCE module successfully unlocked.", "authorized_user": "Admin Aguigam"}	192.168.254.128	2026-04-06 18:51:15.352803	\N
\.
...
SELECT pg_catalog.setval('public.audit_log_tbl_log_id_seq', 570, true);
...
\unrestrict d3R79pgZB6Cmyv0d96fSK7wVDbJJihMNqIJPlvdQW8b3JxGtubxEuGeISln61e4
